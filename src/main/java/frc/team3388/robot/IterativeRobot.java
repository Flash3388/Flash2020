...
public class IterativeRobot implements IterativeRobotInterface {
    ...
    public IterativeRobot(Robot robot) {
        ...
        this.intakeSystem = IntakeSystem.forRobot();
        this.hopperSystem = HopperSystem.forRobot();
        this.feederSystem = FeederSystem.forRobot();
        this.shooterSystem = ShooterSystem.forRobot();
        ...
        right.getButton(0).whileHeld(ActionFactory.visionShootAction(intakeSystem, hopperSystem, feederSystem, turretSystem, shooterSystem, visionSystem));
    }

...
public class IterativeRobot implements IterativeRobotInterface {
    ...
    public IterativeRobot(Robot robot) {
        mRobot = robot;
        mTurretSystem = new TurretSystem(new PWMVictorSPX(RobotMap.TURRET_CONTROLLER) , new AnalogGyro(RobotMap.TURRET_GYRO));
    ...
    public void robotPeriodic() {
        NetworkTableInstance.getDefault().getTable("test").getEntry("gyro").setDouble(mTurretSystem.getAngle());
    }
}

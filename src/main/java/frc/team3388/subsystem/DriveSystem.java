package frc.team3388.subsystem;
...
public class DriveSystem extends TankDriveSystem implements TankFollower {
    ...
    private static final int FRONT_LEFT_CONTROLLER_PORT = 3;
    private static final int REAR_LEFT_CONTROLLER_PORT = 4;
    ...
    public static DriveSystem forRobot() {
        ...
        WPI_TalonSRX frontLeft = new WPI_TalonSRX(FRONT_LEFT_CONTROLLER_PORT);
        WPI_TalonSRX rearLeft = new WPI_TalonSRX(REAR_LEFT_CONTROLLER_PORT);
